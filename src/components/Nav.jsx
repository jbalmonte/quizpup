...
const Nav = () => {
    return (
        <nav className="flex justify-between w-ful h-16 bg-secondary-200 text-gray-100 items-center py-6 px-12 shadow-lg">
            <div className="flex text-left">
                ...
                <h2 className="font-header text-2xl">Quizpup</h2>
            </div>

            <ul className="flex font-body text-right justify-items-end">
                <li className="hover:bg-secondary-100 rounded-md p-2 mx-4 flex">
            ...
            <div>
                ...
                <button type="button" className="button bg-tertiary">Sign up</button>
            </div>

...
const Question = ({ questionCount, questions }) => {
    ...
    return (
        <div className="my-6">
            <fieldset className="text-primary border   bg-green-200 w-3/4 mx-auto rounded-lg p-4 ">
                ...
                <div className="text-right mt-3 pt-1">
                    <span className="text-secondary-100">Correct Answer: </span>
                    <span
                        className={`bg-${correctAnswer ? "yellow-500" : "tertiary"} text-white p-2 rounded-md ml-3 shadow text-center`}>

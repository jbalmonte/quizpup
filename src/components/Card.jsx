...
const Card = () => {
    ...
    return (
        <div className="overflow-hidden h-48 bg-gray-100 shadow text-secondary-200 flex font-body rounded-lg w-full text-left mb-5">
            ...
            <div className="h-full ml-5 flex flex-col justify-evenly relative">
                ...
                <div className="flex justify-between">
                    ...
                    <span className="text-sm my-auto mr-5 text-tertiary hover:underline flex">

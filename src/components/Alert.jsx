...
const Alert = ({ type, message, setError = null }) => {
    ...
    return (
        <div className={`bg-${color}-100 border border-${color}-300 text-${color}-600 px-4 rounded relative`} role="alert" onClick={handleClick}>
            <span className="block sm:inline">{message || 'anyTextHere'}</span>

...
const Categories = ({ history }) => {
    ...
    return (
        <div className="bg-green-300 rounded-lg h-14 flex items-center justify-evenly py-1 px-1 text-lg shadow font-body text-primary font-medium">
            ...
            <NavLink to="/quizzes" exact activeClassName="active-category" className="category" onClick={() => history.push("/all")}>
            ...
            <NavLink to="/quizzes/hot" exact activeClassName="active-category" className="category" onClick={() => history.push("/hot")}>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <NavLink to="/quizzes/new" exact activeClassName="active-category" className="category" onClick={() => history.push("/new")}>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" >
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5.636 18.364a9 9 0 010-12.728m12.728 0a9 9 0 010 12.728m-9.9-2.829a5 5 0 010-7.07m7.072 0a5 5 0 010 7.07M13 12a1 1 0 11-2 0 1 1 0 012 0z" />
                </svg>
                New
            </NavLink>
            <NavLink to="/quizzes/best" exact activeClassName="active-category" className="category" onClick={() => history.push("/best")}>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">

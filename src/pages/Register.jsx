            ...
            <div className=" h-semiScreen sm:flex sm:flex-row mx-0 justify-center">
                <div className="flex-col flex  self-center p-10 sm:max-w-5xl xl:max-w-2xl  z-10">
                    <div className="self-start hidden lg:flex flex-col  text-white">
                        ...
                        <h1 className="mb-3 font-bold text-5xl font-header">Register now!</h1>
                        <p className="pr-3">There are lot of quizzes that you don't want to miss out! Come and join us because you could be the next Quizpup Superstar</p>
                    </div>
                </div>

                <div className="flex justify-center self-center  z-10">
                    <div className="px-12 py-10 bg-white mx-auto rounded-2xl w-100 ">
                        <div className="mb-4">

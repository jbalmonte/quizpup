    ...
    return (
        <main className="flex justify-around h-semiScreen items-center bg-green-100 px-14">
            <div className="max-w-xl">
                ...
                <h2 className="text-xl font-body text-gray-500">Answer and create quizzes to earn points and challenge the other players around the world. The leaderboard awaits you!</h2>
                <Link to="/register">
